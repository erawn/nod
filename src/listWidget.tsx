  ...
  return (
    <>
      ...
      >
        ...
        <span className={ITEM_DETAIL_CLASS} title={runningItem.full_path}>
        ...
        {runningItem.schema.key === props.selectedKey ? (
          ...
          >
            ...
            <span title={connectedLabel} className="jp-Nod-ConnectLabel-Span">
              {connectedLabel}
            </span>
          </Button>
        ) : (
          ...
          >
            {/* <shutdownItemIcon.react tag={null} /> */}
            <span title={shutdownLabel} className="jp-Nod-ConnectLabel-Span">
              {shutdownLabel}
            </span>
          </Button>
        )}
