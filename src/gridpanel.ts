...
// import { nodLogEntry } from './nodLog';
...
//     super();
//     const { commands, entry, themeManager } = options;
//     this.model = entry;
...
//    */
//   setData(entry: nodLogEntry): void {
//     this._clearData();
//     this.emitChanged({
//       type: 'model-reset'
//     });
...
//       this._data.id[index] = variable.id;
